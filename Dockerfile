...
COPY denon_proxy.py http_server.py avr_connection.py avr_state.py avr_discovery.py runtime_utils.py telnet_utils.py web_ui.html runtime_state.py avr_info.py config.py .
